...
Graph.prototype.printAllRoutesUtil = function (s, d, visited, routes, limit, sameSD) {
  visited[s] = true;
  routes.push(s);
...
* @param {int} maxStops
*/
Graph.prototype.printAllRoutes = function (source, destination, maxStops) {
  let visited = {};
...
/**
 * Returns the number of possible routes for the conditions provided
 * @param {Obj} routesMap 
 * @param {String} route 
 */
